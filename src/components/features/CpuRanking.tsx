...
export default function CpuRanking() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch('https://api.pearktrue.cn/api/tianti/zmcpu.php');
              ...
              {filteredData.map((cpu) => (
                ...
                >
                  ...
                  <div className={`
                    ...
                    ${cpu.top <= 3 ? 'bg-gradient-to-br from-purple-500 to-blue-500 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-400'}
                  `}>
                    {cpu.top}
                  </div>
